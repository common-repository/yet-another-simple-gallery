...
function yas_gallery ($atts, $content = null) {
	...
	$gallery = "\n<!-- Yet-another-simple-gallery plugin -->\n<div class=\"yasg_galleryHolder\" id=\"galleryHolder_$post_id\">";
	...
	$gallery .= "<p class=\"navArrows prev\"><img src=\"" . WP_PLUGIN_URL . "/yet-another-simple-gallery/images/prev.png\" width=\"10px\" height=\"20px\" alt=\"previous\" title=\"previous\" class=\"arrow\" id=\"prev_$post_id\" /></p>";
	...
	foreach ($slides as $slide) {
		...
		$slide_alt =  $slide -> post_content; /* Image description */
		...
		$fullURL = $fullObj[0];
		$gallery .= '<li style="margin: 0 '.$yasg_spacing.'px" class="'.$thumb_css_class.'"><a title="'.$fullURL.'" href="'.$slideURL.'"><img width="'.$yasg_thumb_width.'" height="'.$yasg_thumb_height.'" src="'.$thumbnailURL.'" title="'.$slide_title.'" alt="'.$slide_alt.'"></a></li>'.PHP_EOL;
		$is_first = false;
	}
	$gallery .= "</ul>\n";
	$gallery .= "</div>\n";
	$css_visibility = (count($slides) > 10)?'visible':'hidden';
	$gallery .= "<p class=\"navArrows next\"><img src=\"" . WP_PLUGIN_URL . "/yet-another-simple-gallery/images/next.png\" width=\"10px\" height=\"20px\" alt=\"next\" title=\"next\" class=\"arrow\" id=\"next_$post_id\" /></p>";
	$gallery .= "</div>\n";
